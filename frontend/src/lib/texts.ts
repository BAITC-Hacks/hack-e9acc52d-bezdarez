...
export const EXPLAIN = {
  ru: {
    ...
    riskGeneric: 'Расходы на обслуживание проектов сильнее проявятся на длинном горизонте.',
  ...
  kk: {
    ...
    riskGeneric: 'Жобаларға қызмет көрсету шығыны ұзақ мерзімде күштірек байқалады.',
  ...
  en: {
    ...
    riskGeneric: 'Project maintenance costs will weigh more over the long term.',
